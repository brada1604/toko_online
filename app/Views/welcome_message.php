...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?php echo base_url('/info');?>">Info</a></li>
            <li class="menu-item hidden"><a href="<?php echo base_url('/mahasiswa');?>">Mahasiswa</a></li>
            <li class="menu-item hidden"><a href="<?php echo base_url('/pegawai');?>">Pegawai</a></li>
            <li class="menu-item hidden"><a href="<?php echo base_url('/barang');?>">Barang</a></li>
            ...
            <li class="menu-item hidden"><a href="<?php echo base_url('/login');?>">Login</a></li>
            <li class="menu-item hidden"><a href="<?php echo base_url('/register');?>">Register</a></li>
        </ul>
    </div>
